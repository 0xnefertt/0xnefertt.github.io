    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/brookfield-corporation-analysis/";
      ...
      },{id: "post-bibliography-support-removed",
        
          title: "bibliography support removed",
        
        description: "bibliography support has been removed from this site",
        section: "Posts",
        handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%64%72%77%73%73%32@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/0xnefertt", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/0xnefertt", "_blank");
        },
      },{
      id: 'light-theme',
